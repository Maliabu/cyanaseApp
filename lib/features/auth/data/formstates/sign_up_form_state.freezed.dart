...
mixin _$SignupFormState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  AsyncValue<VerifyEmailResponse?>? get response =>
      throw _privateConstructorUsedError;
...
abstract class $SignupFormStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(includeFromJson: false, includeToJson: false)
      AsyncValue<VerifyEmailResponse?>? response});
}
...
class _$SignupFormStateImpl implements _SignupFormState {
  const _$SignupFormStateImpl(
      ...
      @JsonKey(includeFromJson: false, includeToJson: false)
      this.response = const AsyncData(null)});
  ...
  @override
  @JsonKey(includeFromJson: false, includeToJson: false)
  final AsyncValue<VerifyEmailResponse?>? response;

  @override
  String toString() {
    return 'SignupFormState(step: $step, firstName: $firstName, firstNameError: $firstNameError, lastName: $lastName, lastNameError: $lastNameError, phoneNumber: $phoneNumber, phoneError: $phoneError, countryName: $countryName, countryCode: $countryCode, countryFlag: $countryFlag, countryError: $countryError, email: $email, emailError: $emailError, birthDate: $birthDate, birthDateError: $birthDateError, gender: $gender, genderError: $genderError, password: $password, passwordError: $passwordError, confirmPassword: $confirmPassword, confirmPasswordError: $confirmPasswordError, isPasswordVisible: $isPasswordVisible, isConfirmPasswordVisible: $isConfirmPasswordVisible, submission: $submission, response: $response)';
  }
